...
![The object $\mathbf{T}X$ depicted as the wire $X$ wrapped by a $\mathbf{T}$-tube.](images/basictube.svg)
...
![The monoidal laxator](images/monoidalstrength.svg)
...
![Get a load of this guy](images/laxcoherence.svg)
...
![Much simpler](images/slideinpants.svg)
...
![Left and right unitors](images/unitors.svg)

And of course, we would like the laxators to cohere sensibly with braidings.

![Laxator-braid coherence](images/twistpants.svg)
...
![Tensorial strength](images/tensorstrength.svg)
...
![Strength associativity](images/betaassoc.svg)

![Strength unitality](images/betaunitality.svg)

![Strength-braid coherence](images/betatwist.svg)
...
![A learned parameter](images/learner.svg)
...
![An algebra ](images/algebra_colour.svg)
...
![Inner product](images/innerproduct.svg)
...
![Outer product](images/outerproduct.svg)
...
![An abstract attention mechanism](images/attn3.svg)
...
![Before training: an example of Funcformer solving Poisson's equation.](images/before_example.png)

![After training: an example of Funcformer solving Poisson's equation.](images/after_example.png)
